...
def test_route_contract_presence() -> None:
    ...
    path_methods = {(route.path, tuple(sorted(route.methods))) for route in client.app.routes if hasattr(route, "methods")}

    expected = {
        ("/api/v1/health", ("GET", "HEAD")),
        ("/api/v1/health/ready", ("GET", "HEAD")),
        ("/api/v1/auth/login", ("POST",)),
        ("/api/v1/auth/me", ("GET", "HEAD")),
        ("/api/v1/auth/refresh", ("POST",)),
        ("/api/v1/auth/logout", ("POST",)),
        ("/api/v1/patients", ("GET", "HEAD")),
        ("/api/v1/patients", ("POST",)),
        ("/api/v1/patients/{patient_id}", ("GET", "HEAD")),
        ("/api/v1/patients/{patient_id}", ("PUT",)),
        ("/api/v1/cases", ("GET", "HEAD")),
        ("/api/v1/cases/upload", ("POST",)),
        ("/api/v1/cases/{case_id}", ("GET", "HEAD")),
        ("/api/v1/cases/{case_id}/status", ("GET", "HEAD")),
        ("/api/v1/cases/{case_id}/approve", ("PATCH",)),
        ("/api/v1/cases/{case_id}/reject", ("PATCH",)),
        ("/api/v1/analysis/{case_id}", ("GET", "HEAD")),
        ("/api/v1/reports", ("GET", "HEAD")),
        ("/api/v1/reports/generate", ("POST",)),
        ("/api/v1/reports/{report_id}", ("GET", "HEAD")),
        ("/api/v1/reports/{case_id}/doctor", ("GET", "HEAD")),
        ("/api/v1/reports/{case_id}/patient", ("GET", "HEAD")),
        ("/api/v1/reports/{case_id}/pdf", ("GET", "HEAD")),
        ("/api/v1/admin/clinics", ("GET", "HEAD")),
        ("/api/v1/admin/clinics", ("POST",)),
        ("/api/v1/admin/users", ("GET", "HEAD")),
        ("/api/v1/admin/users", ("POST",)),
        ("/api/v1/admin/users/{user_id}/status", ("POST",)),
        ("/api/v1/admin/stats", ("GET", "HEAD")),
    }

    missing = [item for item in expected if item not in path_methods]
...
def test_case_analysis_report_endpoints_with_mocks(monkeypatch) -> None:
    ...
    monkeypatch.setattr(report_service, "get_case_report_json", lambda *_args, **_kwargs: common_report["reportData"])
