...
def test_migration_has_correct_revision():
    from alembic.versions import _0001_initial_schema as migration  # type: ignore
...
def test_migration_has_upgrade_and_downgrade():
    import alembic.versions._0001_initial_schema as migration  # type: ignore
