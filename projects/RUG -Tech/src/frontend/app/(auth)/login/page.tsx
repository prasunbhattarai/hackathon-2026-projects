...
/* ------------------------------------------------------------------ */
/*  SVG retinal vessel background pattern                              */
/* ------------------------------------------------------------------ */
...
const RetinalPattern = () => (
  ...
  >
    {/* Concentric ellipses — optic disc */}
    ...
    {/* Branching vessel lines — temporal */}
    {[
    ...
    {/* Macula region — faint dark circle */}
