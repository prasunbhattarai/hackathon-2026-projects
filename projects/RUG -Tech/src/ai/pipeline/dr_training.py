...
from loader.folder_loader import get_folder_dataset
...
dataset = get_folder_dataset("pipeline/dataset/DR", transform)
...
for epoch in range(7):
    ...
    if val_loss < best:
        best = val_loss
        save_model(model, "models/dr.pth")
        print("Model saved: models/dr.pth")
